...
CREATE TABLE `order_info`  (
  ...
  `reserve_time` tinyint(0) NULL DEFAULT 0 COMMENT '安排时间（0：上午 1：下午）',
...
CREATE TABLE `payment_info`  (
  ...
  `payment_status` tinyint(0) NULL DEFAULT NULL COMMENT '支付状态',
...
CREATE TABLE `refund_info`  (
  ...
  `payment_type` tinyint(0) NULL DEFAULT NULL COMMENT '支付类型（微信 支付宝）',
  `trade_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易编号',
